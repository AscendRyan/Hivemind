    ...
    <div className="min-h-screen">
      ...
      <section className="min-h-screen flex items-center justify-center px-6 pt-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-20 right-1/3 w-28 h-28 bg-primary/20 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
        </div>
        ...
        <div className="container mx-auto max-w-2xl relative z-10">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Help us build the future of AI automation. We're looking for passionate individuals to join our innovative team.
            </p>
          </div>
          ...
          <div className="card-3d p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                Send us your resume and tell us why you'd be a great fit for HiveMind.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-4">
                <Button 
                  type="submit" 
                  disabled={loading || !formData.name || !formData.email || !formData.resume}
